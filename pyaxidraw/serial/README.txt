This directory contains a portion of pySerial 3.2.1, distributed under the BSD License; please see LICENSE.txt.
...
The changes made from the official pySerial distribution are as follows:
  ...
  - The license and README files have been moved into the serial directory.
  - This README has been modified with these notes about modifications, for compliance with the license.



Below follows the content of the original README.rst from the pySerial distribution:
=================================
